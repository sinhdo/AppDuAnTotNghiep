...
import com.example.appduantotnghiep.activity.ChangePassword_Activity;
import com.example.appduantotnghiep.activity.DiscountActivity;
import com.example.appduantotnghiep.activity.ListUserActivity;
import com.example.appduantotnghiep.activity.LocationActivity;
import com.example.appduantotnghiep.activity.ManHinhChoActivity;
import com.example.appduantotnghiep.activity.ManagerProductActivity;
import com.example.appduantotnghiep.activity.OrderOfShopActivity;
import com.example.appduantotnghiep.activity.StatisticalActivity;
import com.example.appduantotnghiep.activity.TopUpCardActivity;
import com.example.appduantotnghiep.activity.XacNhanCardActivity;
...
public class ProfileFragment extends Fragment implements View.OnClickListener{
    ...
    private CardView cvOut,cvOder,cvPayment,cvTK,cvPromotion,cvQLUser,cvQLProduct,cvChangePass,cvAdddiachi,cvXacNhanCard;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (name.isEmpty()) {
            ...
            if (phone.equals("")||phone==null){
                textSDT.setText("Chưa có số điên thoại");
            }else {
