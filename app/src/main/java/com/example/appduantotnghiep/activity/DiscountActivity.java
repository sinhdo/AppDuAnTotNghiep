...
import com.example.appduantotnghiep.adapter.DiscountAdapter;
import com.example.appduantotnghiep.model.Discount;
...
public class DiscountActivity extends AppCompatActivity {
    ...
    private void addDiscount() {
        ...
        if (currentUser != null) {
            ...
            if (value < 1000) {
                Toast.makeText(this, "Value Discount phải có giá trị ít nhất 1000 VNĐ", Toast.LENGTH_SHORT).show();
                return;
            }
        ...
        discountRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    ...
                    if (currentUser != null && discount != null) {
